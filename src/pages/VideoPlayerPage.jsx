...
import { FaPlay, FaPause, FaVolumeUp, FaVolumeMute, FaExpand, FaCompress, FaHome, FaArrowLeft, FaStar, FaCalendarAlt, FaClock } from 'react-icons/fa';
    ...
    return (
        ...
        >
            ...
            <div className="relative pt-16">
                <ReactPlayer
                    ref={playerRef}
                    url={videoData.streamUrl || videoData.videoUrl}
                    playing={playing}
                    volume={volume}
                    muted={muted}
                    width="100%"
                ...
                <div className={`absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent transition-opacity duration-300 ${showControls ? 'opacity-100' : 'opacity-0'}`}>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <button
                            ...
                            className="p-6 bg-red-600 hover:bg-red-700 rounded-full transition-all transform hover:scale-110"
                        >
                            {playing ? (
